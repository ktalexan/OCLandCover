...
class HLSv2:
    ...
    def project_metadata(self, silent: bool = False) -> dict:
        ...
        # Import the ochls_metadata json file
        metadata_file = os.path.join(os.getcwd(), "metadata", "ochls_metadata.json")
        ...
        # Set the metadata title and name based on the part and description
        prj_meta["title"] = "OCHLS"
        prj_meta["name"] = "Orange County Harmonized Landsat Sentinel v2"
        prj_meta["description"] = "Orange County Harmonized Landsat Sentinel v2 (OCHLS) is a project to harmonize and process Landsat and Sentinel-2 satellite imagery for Orange County, California. The project aims to create a comprehensive dataset of land cover and land use changes in the region over time."
    ...
    def project_directories(self, silent: bool = False) -> dict:
        ...
        prj_dirs = {
            ...
            "gis_folder": os.path.join(self.base_path, "gis", "ochls"),
            "gis_folder_aprx": os.path.join(self.base_path, "gis", "ochls", "ochls.aprx"),
            "gis_folder_gdb": os.path.join(self.base_path, "gis", "ochls", "ochls.gdb"),
